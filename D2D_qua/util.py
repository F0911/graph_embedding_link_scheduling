...
cmd_opt.add_argument('-node_dim', type=int, default=0, help='dimension of node feature')
cmd_opt.add_argument('-edge_dim', type=int, default=1, help='dimension of edge feature')
...
cmd_opt.add_argument('-hidden1', type=int, default=100, help='dimension of regression 1')
cmd_opt.add_argument('-hidden2', type=int, default=100, help='dimension of regression 2')
cmd_opt.add_argument('-max_lv', type=int, default=2, help='max rounds of message passing')
cmd_opt.add_argument('-link_num', type=int, default=0, help='number of links')
cmd_opt.add_argument('-graph_num', type=int, default=0, help='number of training graphs')
cmd_opt.add_argument('-val_num', type=int, default=0, help='number of validation graphs')
cmd_opt.add_argument('-learning_rate', type=float, default=0.0001, help='init learning_rate')
cmd_opt.add_argument('-do_bn', type=ast.literal_eval, default=False, help='batch normalization')
